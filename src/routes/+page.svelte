...
const data = [
  {
    title: [
      ...
      { text: "." },
      { text: "one", description: "i'm the one" },
    ],
    href: "https://somni.one",
    subdomains: [
      {
        title: "> whoami",
        href: "https://somni.one/me",
      },
      {
        title: "> blog",
        href: "https://log.somni.one",
      },
    ],
  },
  {
