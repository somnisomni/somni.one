<div class="page">
  ...
  <section>
    ...
    <div class="content in-a-nutshell">
      ...
      <p>&nbsp;최근 <a href="https://ck.ac.kr/school-department/game/school">청강문화산업대학교 게임콘텐츠스쿨</a>에서 졸업했으며, 졸업 작품으로 게임 프로젝트 「<a href="https://ck25-palette.notion.site/Palette-KOR-22bd7b6d0d0c80a8917aebee9471b57d">컬러팅! 캐치 & 라비</a>」를 개발했습니다.</p>
...
.page {
  ...
  .nav {
    @apply text-accent font-mono uppercase mb-4;
  }
